      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h3 className="text-lg font-semibold text-ilovepdf-blue">AI Tools</h3>
            <p className="mt-2 text-sm text-gray-500">
              Interface para upload de Tomografias Computadorizadas para predição de AVC("Derrame").
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-500">
                <li><a href="#" className="hover:text-ilovepdf-blue">Predição de AVC</a></li>
